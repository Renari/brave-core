...
class BraveWalletPermissionPromptImpl : public permissions::PermissionPrompt {
 public:
  ...
  BraveWalletPermissionPromptImpl(const BraveWalletPermissionPromptImpl&) = delete;
  BraveWalletPermissionPromptImpl& operator=(const BraveWalletPermissionPromptImpl&) =
      delete;
